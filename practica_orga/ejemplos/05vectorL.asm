...
section	.data
	msgSalida			db	'Elementos guardados en posicion %i: %i y %s',10,13,0

	vecNombre			db "Zulema   ",0,"Elvira   ",0,"Filomena ",0,"Leonor   ",0,"Asunta   ",0
	vecNumero			dw	100,-200,32767,40,1979
...
main:
	...
	lea		rcx,[vecNombre+ebx];Param 4: Direccion del tercer dato a imprimir (string)
	call	printf
    cmp     rcx, 00
    je      fin
    jmp     main ;?    
